...
orig_path = os.getcwd()
os.chdir(r"C:\Users\admin\Documents\data\HER2-_Ki67_nad_14")
...
LUMB_CD4.columns = ['LUMA' + str(i + 1) for i in range(5)]

os.chdir(r"C:\Users\admin\Documents\data\HER2-_Ki67_pod_14")
...
LUMA_CD4.columns = ['LUMB' + str(i + 1) for i in range(5)]

os.chdir(r"C:\Users\admin\Documents\data\TNBC")
...
print(LUMB_CD4, LUMA_CD4, TNBC_CD4)


os.chdir(orig_path)
# merge = pd.concat([LUMA_CD4, LUMB_CD4, TNBC_CD4], axis=1)
merge = LUMB_CD4.join(LUMA_CD4).join(TNBC_CD4)
...
merge1 = pd.concat([LUMB_CD4, LUMA_CD4, TNBC_CD4], axis=1)
